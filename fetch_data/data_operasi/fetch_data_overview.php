...
$sql_forecast = "SELECT beban_prediksi FROM load_forcasting WHERE DATE(tanggal) =  CURDATE()";
...
$sql_beban_forecast = "SELECT beban_prediksi FROM load_forcasting WHERE DATE(tanggal) =  CURDATE()";
$sql_beban_puncak_forecast = "SELECT MAX(beban_prediksi) as nilai_tertinggi FROM load_forcasting WHERE DATE(tanggal) =  CURDATE()";
